 ...
 *
 * For presigned deletes from the client, use `presignUrl(controlPlaneBlobDeleteUrl(pathname), signedToken, 'delete')`
 * from the main `@vercel/blob` entry (same route, with delegation/signature query params).
 *
