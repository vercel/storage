...
export type {
  EdgeConfigClient as GlobalConfigClient,
  EdgeConfigItems as GlobalConfigItems,
  EdgeConfigValue as GlobalConfigValue,
  EmbeddedEdgeConfig as EmbeddedGlobalConfig,
};
